...
class VerificationPageForgetPassword extends StatefulWidget {
  const VerificationPageForgetPassword();
  @override
  State<VerificationPageForgetPassword> createState() => _VerificationState();
}

class _VerificationState extends State<VerificationPageForgetPassword> {
